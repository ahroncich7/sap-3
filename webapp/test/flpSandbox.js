		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "destination3",
									"targetURL": "#dest3destination3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dest3destination3-display": {
								"semanticObject": "dest3destination3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dest3.destination3",
									"url": sap.ui.require.toUrl("dest3/destination3")
								}
							}
						}
					}
